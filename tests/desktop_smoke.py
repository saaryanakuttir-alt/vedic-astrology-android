...
rtxt2 = " ".join(texts(app._screens["relationship"]))
check("Year by year from age 6" in rtxt2 and "Age 6 (" in rtxt2 and "not a real probability" in rtxt2, "Relationship shows the year-by-year outlook from age 6")
check(rtxt2.count("Age ") >= 60, "...one line per year")
